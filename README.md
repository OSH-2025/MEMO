...
| 调研报告（`Due 3.30`） | 3.27      | **第四次会议(线下)**<br />集中研读了往届作业的github，分析和我们课题的关系、以及可以学习利用的部分<br />拟定了调研报告的框架，讨论写作时要注意的问题 $`*`$，分工并采用USTC Latex协作<br /> | **调研报告主体**分工<br />贾钰珩： 1.1 Linux 系统的内存管理<br/>韩思琦： 1.2 LLM及部署<br/>杨玺禾： 2.1 利用LLM优化Linux内存管理<br/>于宛扬： 2.2 LLM与OS的交互 |
|                           |           |                                                              |                                                              |
